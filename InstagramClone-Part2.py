...
def downloader():
    ...
    query = " SELECT ID,d1.File_Name,Image_type,Uploaded_time FROM image_details d1, details d2 where d1.File_Name = d2.File_Name and quantity  > " +  froma + " and quantity < " + to + ""
